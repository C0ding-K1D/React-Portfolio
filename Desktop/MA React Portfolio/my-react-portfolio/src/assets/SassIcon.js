...
import classes from './SassIcon.module.css';
...
function SassIcon() {
    ...
    const animatedFill = useSpring({
        fill: toggle ? "#dc80a1": 'transparent',
        delay: 2200,
    })
  ...
  return (
    <Fragment>
        <svg className={classes.placement} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="100">
        <animated.path
